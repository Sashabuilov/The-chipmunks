...
public class ChipmunksActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        gameTime.setText("Time: 0");
        gameTime.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/MarkerFelt.ttf"));
        tv_result = findViewById(R.id.tv_resultat);
        tv_result.setText("0");
        tv_result.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/MarkerFelt.ttf"));
        ...
        //btnNewGame.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/MarkerFelt.ttf"));

        Button btnAbout = findViewById(R.id.btn_about);
        //btnAbout.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/MarkerFelt.ttf"));

        Button btnSettings = findViewById(R.id.btn_Settings);
        //btnSettings.setTypeface(Typeface.createFromAsset(getAssets(),"fonts/MarkerFelt.ttf"));
    ...
    private void refreshTimerText() {
        gameTime.setText("Time: " + timerSeconds / 1000);
    }
